...
export function AddUserModal({ isOpen, onClose, onAdd }) {
          ...
          <Card>
            <div className="flex items-center justify-between p-6 border-b border-gray-100 dark:border-gray-800">
              <Dialog.Title className="text-lg font-semibold text-gray-900 dark:text-white">
                Add New {formData.role === 'client' ? 'Customer' : 'Team Member'}
              </Dialog.Title>
              <button
                onClick={onClose}
            ...
            <form onSubmit={handleSubmit}>
              <div className="p-6 space-y-4">
                <AvatarPicker
                  type={formData.role === 'client' ? 'customer' : formData.department}
              ...
              <div className="flex items-center justify-end gap-3 p-6 border-t border-gray-100 dark:border-gray-800">
                ...
                <Button type="submit">
                  Add {formData.role === 'client' ? 'Customer' : 'Team Member'}
                </Button>
              </div>
            </form>
          </Card>
