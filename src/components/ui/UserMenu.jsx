...
export function UserMenu({ onNavigate }) {
  ...
  return (
    <Menu as="div" className="relative">
      ...
      <Menu.Items className="absolute right-0 mt-1 w-64 bg-white dark:bg-dark-card rounded-xl shadow-lg border border-gray-100 dark:border-gray-800 focus:outline-none">
